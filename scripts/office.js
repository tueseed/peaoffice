...
function fetch_officr(obj)
{
    ...
    while(obj[i])
    {
        ...
        html_card = html_card + '<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-3"><a class="card nav-link" href="?action=tr_detail&pea_no='+obj[i].pea_name+'"><div class="card-body"><div class="row"><div class="col-auto"><p>Pea: '+obj[i].pea_name+'</p></div><div class="col"><span class="text-primary"><i class="fas fa-info-circle fa-2x float-right"></i><span></div></div></div> </a></div>';
        i++;
    }
